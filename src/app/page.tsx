...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // https://fastapi.varidhsrivastava19145.workers.dev/api/search?q=in
      const res = await fetch(`https://fastapi.varidhsrivastava19145.workers.dev/api/search?q=${input}`)
